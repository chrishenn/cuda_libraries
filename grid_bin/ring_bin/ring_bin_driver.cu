...
std::vector<torch::Tensor> ring_bin_cuda_call(
    torch::Tensor counts,
    ...
    if (shared > 49152){
        fprintf (stderr, "ERROR RING_BIN: ATTEMPTED TO ALLOCATE TOO MUCH SHARED MEMORY FOR YOUR DEVICE ARCH; DECREASE OBJECT-DENSITY\n");
