...
__global__ void frnn_main_kernel(
    ...
    LoadBin(pts, bin_ptids, bin_a, *bin_Astart, *bin_Anum, pt_size1, bin_stride);

    LoadBin(pts, bin_ptids, bin_b, *bin_Bstart, *bin_Bnum, pt_size1, bin_stride);
    __syncthreads();
